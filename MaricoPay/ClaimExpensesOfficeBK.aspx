<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ClaimExpensesOfficeBK.aspx.cs" Inherits="MaricoPay.ClaimExpensesOfficeBK" %>
                ...
                <div>
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="color: #000000;">
                                <telerik:RadDatePicker ID="raddateFrom" runat="server" Width="100px">
                                    <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" EnableWeekends="True"
                                        FastNavigationNextText="&amp;lt;&amp;lt;">
                                    </Calendar>
                            ...
                            <td style="color: #000000;">
                                <telerik:RadDatePicker ID="raddateTo" runat="server" Width="100px">
                                    <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" EnableWeekends="True"
                                        FastNavigationNextText="&amp;lt;&amp;lt;">
                                    </Calendar>
                                    <DateInput DisplayDateFormat="dd-MMM-yy" DateFormat="dd-MMM-yy" LabelWidth="40%">
                            ...
                            <td colspan="3" style="color: #000000;">
                                <asp:TextBox ID="txtPurpose" runat="server" Width="330px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </div>
