<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintClaim.aspx.cs" Inherits="MaricoPay.PrintClaim" %>
                        ...
                        <table cellpadding="2" cellspacing="0" style="width: 100%; border: 1px solid black;
                            ...
                            <thead>
                                <tr style="border: 1px solid black; border-collapse: collapse">
                                    <th rowspan="2" align="center" style="color: #000000; border: 1px solid black; border-collapse: collapse;
                                        font-weight: bold;">
                                        From
                                    </th>
                                    <th rowspan="2" align="center" style="color: #000000; border: 1px solid black; border-collapse: collapse;
