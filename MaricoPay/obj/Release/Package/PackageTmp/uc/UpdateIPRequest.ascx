<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateIPRequest.ascx.cs"
    Inherits="MaricoPay.uc.UpdateIPRequest" %>
...
<div style="text-align: left; margin-left: 20px">
    <table cellpadding="3" cellspacing="2" border="0">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="RadComboIO"
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="radcomboCostcenter"
                        ...
                        <td>
                            <telerik:RadComboBox ID="radcomboGL" runat="server" Width="150px" DataTextField="Description" DropDownWidth="400px"
                                DataValueField="GL" Filter="Contains" AllowCustomText="True"  MarkFirstMatch="true"  Font-Size="Small" Font-Names="Arial">
                                <ItemTemplate>
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr valign="middle">
                        ...
                        <td>
                            <telerik:RadComboBox ID="radcomboMatrialGroup" runat="server" Width="150px" DataTextField="Description" DropDownWidth="300px"
                                DataValueField="MaterialGroup" Filter="Contains" AllowCustomText="True"  MarkFirstMatch="true"  Font-Size="Small" Font-Names="Arial">
                                <ItemTemplate>
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr valign="middle">
                                            <td style="width: 150px; text-align: left;">
                    ...
                    <tr>
                        <td>
                            <telerik:RadComboBox ID="radcomboProfitcenter" runat="server" Width="150px" DataTextField="Description" DropDownWidth="300px"
                                DataValueField="Profitcenter" Filter="Contains" AllowCustomText="True"  MarkFirstMatch="true"  Font-Size="Small" Font-Names="Arial">
                                <ItemTemplate>
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr valign="middle">
                                            <td style="width: 150px; text-align: left;">
        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="RadComboMaterial" DataTextField="Name" DataValueField="ID"
                    Width="450px" runat="server" Filter="Contains" AllowCustomText="True" MarkFirstMatch="true"  Font-Names="Arial"
                    Font-Size="Small">
                </telerik:RadComboBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="RadComboMaterial"
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="radnumSoLuong"
        ...
        <tr>
            ...
            <td>
                <%-- <asp:FileUpload ID="FileUpload1" Width="260px" runat="server" accept=".jpg, .png, .gif, .psd, .pdf, .zip" />--%>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="radDateNgayGiao"
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="dropNoiNhan"
            ...
            <td colspan="3">
                <asp:ImageButton ID="btnEdit" runat="server" CommandName="Update" ImageUrl="~/images/luuEn.png"
                    ValidationGroup="GEdit" />
                     &nbsp;
               <asp:ImageButton ID="btnCopy" runat="server" ImageUrl="~/Images/saochepEn.png"
                    CommandName="Copy" OnClick="btnCopy_Click" />
    ...
    <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# fGet(Eval("IDPRDetail"),Eval("IDPR"),Eval("IO"),Eval("IDMaterial"),Eval("TenHang"),Eval("KichThuoc"),Eval("ChatLieu"),Eval("DoDay"),Eval("CoDen"),Eval("HinhMau"),Eval("SoLuong"),Eval("NgayGiao"),Eval("NoiNhan"),Eval("ChiTietKhac"),Eval("Costcenter"),Eval("GL"),Eval("MaterialGroup"),Eval("Profitcenter"),Eval("Country"),Eval("Division"),Eval("SalesGroup"))%>' />
</div>
