<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ASPFDetail.ascx.cs" Inherits="MaricoPay.uc.ASPFDetail" %>
                        ...
                        <MasterTableView DataKeyNames="ID">
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn>
                                    ...
                                    <ItemTemplate>
                                        <telerik:RadComboBox ID="RadComboBox1"  DataTextField="item" AutoCompleteSeparator="true" runat="server" DataValueField="ID" OnSelectedIndexChanged="Rdcode_SelectedIndexChanged">
