<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProviderASPNo.aspx.cs" Inherits="MaricoPay.ProviderASPNo" %>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <telerik:RadComboBox ID="Rdcbocountry" runat="server" DataTextField="Country" DataValueField="ID" AutoPostBack="True"></telerik:RadComboBox>
                        ...
                        <MasterTableView DataKeyNames="ID">
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn DataField="ID" Display="false" HeaderText="ID" UniqueName="ID">
                                 ...
                                 <telerik:GridTemplateColumn DataField="ioold" HeaderText="IO Old" UniqueName="ioold">
                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                    <ItemTemplate>
                                        <asp:Label ID="lbtIoNumber" runat="server" Text='<%# Eval("ioold") %>'> </asp:Label>

                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridTemplateColumn UniqueName="IO" Display="true">
                                    <HeaderTemplate>
                                        <asp:Label ID="RGKienThuclbtSubgoal4Q2"
                                            runat="server">IO</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtIO" runat="server" Width="80px" Value='<%# Eval("IOnumber") %>'></asp:TextBox>
