<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="IPVendorMaterial.aspx.cs" Inherits="MaricoPay.IPVendorMaterial" %>
            ...
            <telerik:RadGrid ID="RG" Width="100%" runat="server" AutoGenerateColumns="False"
                ...
                <MasterTableView CommandItemDisplay="TopAndBottom">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Material" UniqueName="Material" DataField="Material"
                            FilterControlWidth="100px" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                            AutoPostBackOnFilter="true" Display="false">
                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="Material" UniqueName="MaterialName" DataField="MaterialName"
                            FilterControlWidth="100px" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                        ...
                        <telerik:GridBoundColumn HeaderText="Vendor" UniqueName="Vendor" DataField="Vendor"
                          ...
                          <telerik:GridBoundColumn HeaderText="Vendor" UniqueName="VendorName" DataField="VendorName"
                            FilterControlWidth="100px" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                            AutoPostBackOnFilter="true" >
                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
