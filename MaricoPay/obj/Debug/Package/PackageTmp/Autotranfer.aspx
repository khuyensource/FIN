<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Autotranfer.aspx.cs" Inherits="MaricoPay.Autotranfer" %>
    ...
    <p>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="rdcboBU_From" runat="server" DataTextField="BU" DataValueField="ID" AutoPostBack="True" OnSelectedIndexChanged="rdcboBrand_From_SelectedIndexChanged"></telerik:RadComboBox>
                </td>
                <td>&nbsp;</td>
                <td>Ngành hàng/Bussiness Unit</td>
                <td>
                    <telerik:RadComboBox ID="rdcboBU_To" runat="server" DataTextField="BU" DataValueField="ID" AutoPostBack="True" OnSelectedIndexChanged="rdcboBrand_To_SelectedIndexChanged"></telerik:RadComboBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="RdBrand_From" runat="server" DataTextField="Brand" DataValueField="ID" AutoPostBack="True" OnSelectedIndexChanged="RdBrand_From_SelectedIndexChanged"></telerik:RadComboBox>
                </td>
                <td>&nbsp;</td>
                <td>Nhãn hàng/Brand</td>
                <td>
                    <telerik:RadComboBox ID="RdBrand_To" runat="server" DataTextField="Brand" DataValueField="ID" AutoPostBack="True" OnSelectedIndexChanged="RdBrand_To_SelectedIndexChanged"></telerik:RadComboBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="RdCat_From" runat="server" DataTextField="Category" DataValueField="ID" AutoPostBack="True" OnSelectedIndexChanged="RdCat_From_SelectedIndexChanged"></telerik:RadComboBox>
                </td>
                <td>
                ...
                <td>Chủng loại/Category</td>
                <td>
                    <telerik:RadComboBox ID="RdCat_To" runat="server" DataTextField="Category" DataValueField="ID" AutoPostBack="True" OnSelectedIndexChanged="RdCat_To_SelectedIndexChanged"></telerik:RadComboBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="RdActivityGroup_From" runat="server" DataTextField="ActivityGroup" DataValueField="ID" AutoPostBack="True" OnSelectedIndexChanged="RdActivityGroup_From_SelectedIndexChanged"></telerik:RadComboBox>
                </td>
                <td>&nbsp;</td>
                <td>Hoạt động/Activity Group</td>
                <td>
                    <telerik:RadComboBox ID="RdActivityGroup_To" runat="server" DataTextField="ActivityGroup" DataValueField="ID" AutoPostBack="True" OnSelectedIndexChanged="RdActivityGroup_To_SelectedIndexChanged"></telerik:RadComboBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
