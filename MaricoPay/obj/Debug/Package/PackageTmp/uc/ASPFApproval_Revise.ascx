<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ASPFApproval_Revise.ascx.cs" Inherits="MaricoPay.uc.ASPFApproval_Revise" %>
   ...
   <%-- <tr>
    ...
    <tr>
        ...
        <td colspan="2">
                ...
                <a id="A1" runat="server" style="background-color: #FFFFFF; color: #FF0000">Attached file </a> 
        </td>
        <td>
            &nbsp;</td>
        <%-- <td>
...
|
     <asp:Button ID="btnSubmit" runat="server" Text="Approval" OnClick="btnSubmit_Click" Font-Bold="True" Font-Size="14px"  /> 
|
...
&nbsp;
    ...
    <table width="600px">
        ...
        <MasterTableView  >
           ...
           <tr>
             <td>
                Document's old Transition History

           
                <telerik:RadGrid ID="RadGrid11" Skin="Default" runat="server" AutoGenerateColumns="False" Font-Names="Arial" Font-Size="Small" 
        GridLines="Horizontal" >
        <MasterTableView  >
