<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vendor.aspx.cs" Inherits="MaricoPay.vendor" %>
         ...
         <%--<tr>
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPurOrg" runat="server" ReadOnly="true" Width="300px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="2">
