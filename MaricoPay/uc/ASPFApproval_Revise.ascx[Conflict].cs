...
{
    public partial class ASPFApproval_Revise : System.Web.UI.UserControl
    {
        ...
        private void LoadData()
        {
         ...
         void loadHistory ()
         {
             DataTable tbl = cls.GetDataTable("Sp_load_Approve_History", new string[] { "@asp_id" }, new object[] { Request.QueryString["revise"].ToString() });
