<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ReportClaimSales.aspx.cs" Inherits="MaricoPay.ReportClaimSales" %>
                    ...
                    <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" GridLines="Both"
                        ...
                        <MasterTableView EnableHeaderContextMenu="true">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn HeaderText="Số tiền<br/>Amount" DataField="DocTot" UniqueName="DocTot"
                                    EmptyDataText="" FilterControlWidth="70px" Display="true" DataFormatString="{0:N0}">
