      ...
      public ketquaSign AddSinagureFooterWord1(string filedoc, string fileimage, string outputfile, float left, float top)
        {
            ...
            kq.bketqua = false;
            kq.noidung = "";
            FileAttributes attributes = File.GetAttributes(filedoc);
            if ((attributes & FileAttributes.Hidden) == FileAttributes.Hidden)
            {
                 kq.bketqua=true;
                 kq.noidung = "Hidden file";
            }
            else
            {
                ...
                try
                {
                    ...
                    if (proctectedtype != Microsoft.Office.Interop.Word.WdProtectionType.wdNoProtection)
                    {
                        ...
                        {
                            kq.noidung = kq.noidung + e2.Message;
                        }
                    }
                ...
                {
                    kq.bketqua = false;
                    kq.noidung = kq.noidung + e1.Message;
                }
                ...
                if (oMyDoc.ProtectionType == Microsoft.Office.Interop.Word.WdProtectionType.wdNoProtection)
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        //kq = e.Message;
                        kq.bketqua = false;
                        kq.noidung = kq.noidung + e.Message;
                    }
                }
                else
                {
                    ...
                    //  oMyDoc.SaveAs2(outputfile, objNull, objNull, objNull, objNull, objNull, objNull, true, objNull, objNull, objNull, true, objNull, objNull, objNull, objNull, objNull);
                    kq.bketqua = false;
                    kq.noidung = kq.noidung + "File has been protected " + proctectedtype.ToString();
                    oMyDoc.Close(false);
                    oWord.Quit(false);
                }
            }
   ...
   //    private Microsoft.Office.Interop.Word.ApplicationClass MSdoc;
        ...
        {   //Creating the instance of Word Application  
           ...
           // if (MSdoc == null) MSdoc = new Microsoft.Office.Interop.Word.ApplicationClass();
            //FileAttributes attributes = File.GetAttributes(Source.ToString());
            //if ((attributes & FileAttributes.Hidden) != FileAttributes.Hidden)
            //{
        ...
        //public ketquaSign AddSinagureFooterPdf(object Source, string fileimage, object Target)
        //{
        //    ketquaSign kq;
        //    kq.bketqua = false;
        //    kq.noidung = "";
        //    Aspose.Pdf.Rectangle imageRectangle = new Aspose.Pdf.Rectangle(0, 0, 30, 15);
        //    using (Aspose.Pdf.Document document = new Aspose.Pdf.Document(Source.ToString()))
        //    {
        //        using (var imageStream = File.Open(fileimage, FileMode.Open))
        //        {
        //            Aspose.Pdf.XImage image = null;
        //            foreach (Aspose.Pdf.Page page in document.Pages)
        //            {
        //                Aspose.Pdf.Annotations.WatermarkAnnotation annotation = new Aspose.Pdf.Annotations.WatermarkAnnotation(page, page.Rect);
        //                Aspose.Pdf.XForm form = annotation.Appearance["N"];
        //                form.BBox = page.Rect;
        ...
        //                form.Contents.Add(new Aspose.Pdf.Operator.Do(name));
        ...
        //public ketquaSign AddSinagureFooterPdf1(string Source, string fileimage, string Target)
        //{
        //    ketquaSign kq;
        //    kq.bketqua = false;
        //    kq.noidung = "";
        ...
        //    FileStream imageStream = new FileStream(fileimage, FileMode.Open);
        ...
        //    return kq;
        //}
        public ketquaSign AddSinagureFooterPdf(string Source, string fileimage, string Target, float left, float top)
        {
            ketquaSign kq;
            kq.bketqua = false;
            kq.noidung = "";
            try
            {
                using (Stream inputPdfStream = new FileStream(Source, FileMode.Open, FileAccess.Read, FileShare.Read))
                using (Stream inputImageStream = new FileStream(fileimage, FileMode.Open, FileAccess.Read, FileShare.Read))
                using (Stream outputPdfStream = new FileStream(Target, FileMode.Create, FileAccess.Write, FileShare.None))
                {
                    iTextSharp.text.pdf.PdfReader reader = new iTextSharp.text.pdf.PdfReader(inputPdfStream);
                    iTextSharp.text.pdf.PdfReader.unethicalreading = true;
               //     reader..unethicalreading = true;
                    iTextSharp.text.pdf.PdfStamper stamper = new iTextSharp.text.pdf.PdfStamper(reader, outputPdfStream);
                  //  var pdfContentByte = stamper.GetOverContent(1);
                    int p = reader.NumberOfPages;
                    iTextSharp.text.Image image = iTextSharp.text.Image.GetInstance(inputImageStream);
                    //kich thuoc anh
                    image.ScaleToFit(30, 32);
                    //vi tri them vao file
